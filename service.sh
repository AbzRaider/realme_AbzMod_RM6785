...
#KernelTweaks
echo 90> /proc/sys/kernel/boost_task_threshold
...
echo 60>/dev/stune/foreground/schedtune.boost
	...
	# Background
	echo 30> /dev/stune/background/schedtune.util.max.effective
